...
namespace Forbid
{
    ...
    /// </summary>
    public static class ForbidPositiveFloatExtensions
    {
        /// <summary>
        ...
        public static float Positive(this IForbid forbid, float input) => ForbidPositiveDefault.Positive(input);
        ...
        /// <returns><see cref="float"/> input.</returns>
        public static float Positive(this IForbid forbid, float input, string message) =>
        ...
        /// <returns><see cref="float"/> input.</returns>
        public static float Positive(this IForbid forbid, float input, Exception exception) =>
